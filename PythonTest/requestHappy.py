...
intereses = [{'value':'Boca', 'category':'Deporte'},{'value':'Cuba','category':'Viajes'},{'category': u'Me interesa conocer', u'value': u'Mujeres'}]
interesesput = [{'value':'Boca', 'category':'Deporte'},{'value':'Brasil','category':'Viajes'},{'category': u'Me interesa conocer', u'value': u'Mujeres'}]
...
r={}
userPut = { 'age':47,'sex':'Mujer' ,'gcm_registration_id':'aaaaaaaaaa'	,'interests':interesesput}
r['user']=userPut
...
response = requests.get('http://'+host+':8080/interests/', headers=auth)
print response
print response.json()
...
response = requests.delete(url,headers=auth)
print response
url='http://'+host+':8080/token/singin/'
print url
print 'post SINGIN'
print token_json
print url
