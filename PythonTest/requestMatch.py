...
user2 = {'gcm_registration_id':"aaaaaaaaaa",'name':user2,'password': "hashed",'interests':intereses2,'location':ubicacion,'alias':user2,'age':45,'sex':'Mujer','photo_profile':foto,'email':mail2}
...
r={}
userPut = { 'age':47,'sex':'Mujer' ,'gcm_registration_id':"aaaaaaaaaa"	}
r['user']=userPut
