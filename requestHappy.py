...
urlGetUser = 'http://localhost:8000/users/5/'
urlDeleteUser = 'http://localhost:8000/users/14/'
urlPutPhoto = 'http://localhost:8000/users/15/photo'
...
dataUserPost = {
    ...
    "sex":"SexoPrueba",
     "age":"45",
    "email": "usuarioFeliz7"+str(rdm)+"@usuario.com",
		"interests": [{
                "value": "Asado",
                "category": "food"
                },
...
print response
print "delete user"
response = requests.delete(urlDeleteUser, headers=auth,data=dataUserPut_json)
print response
print "photo"
print "put"
